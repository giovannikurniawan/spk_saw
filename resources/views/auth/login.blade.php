                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block text-center" id="title">
                                <h3>
                                    Sistem Pendukung Keputusan Metode Simple Additive Weighting </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="email" type="email"
                                                class="form-control from-control-user @error('email') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            <input id="password" type="password"
                                                class="form-control custom-control-user @error('password') is-invalid @enderror"
